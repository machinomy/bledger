...
class APDUResponse {
   ...
   * @throws {APDUError}
   *
   * see: https://ledgerhq.github.io/btchip-doc/bitcoin-technical.html#_sign_message
   * p = parity of first byte
   * add 27 to p if public key not compressed, otherwise add 31
   * base64(p | r || s)
   */
  ...
  static signMessage(data, first = true) {
    ...
    if (!first) {
      ...
      // ??
      // see line 595
      // nodar doesn't remember why he did that
      data[0] &= 0xFE;

      // TODO: return new APDUResponse
      return { data };
    }
